...
|------|----------|--------|--------|-----------|------|
| bga_real | 202장 | 2 (type3,4) | **78.0%** | 47.7% | 기본 데이터셋 |
| merged_real | 242장 | 4 (Type1-4) | 33.3% | 19.8% | 4클래스 확장 |

**분석**:
- 기본 데이터셋(2클래스)에서 **78% mAP50** 달성으로 실사 데이터 적용 가능성 검증
- 4클래스 확장 시 클래스 불균형으로 인해 성능 저하 발생
- Type3, Type4가 주요 결함 클래스로, 해당 클래스에 대한 검출 성능이 우수
...
| 데이터 규모 | 500장, 98,000 범프 | 202~242장 |
| 클래스 수 | 6종 결함 | 2~4종 결함 |
| mAP@50 | 93.2% | **78.0%** (2클래스) |
| mAP@50-95 | 87.6% | **47.7%** |
